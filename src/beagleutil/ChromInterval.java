...
public final class ChromInterval implements IntInterval,
     ...
     * {@code [start]} and {@code [end]} are integers
     * satisfying {@code [start]<=[end]}.  If the specified
    ...
    /**
     * Returns a string describing {@code this}.  This format of the
     * returned string is unspecified and subject to change.
